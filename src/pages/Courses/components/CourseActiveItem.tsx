    ...
    return (
        <div className="min-h-36 flex flex-col rounded-sm border border-stroke-100 py-4 px-6">
            <div className="flex justify-between gap-2 flex-1">
                <p className="max-2xl:text-p1-semibold text-p2-semibold">{title}</p>
                <NavLink
                    to={lastModule.address}
                    className="flex w-2/5 justify-end gap-2 text-wrap max-2xl:text-caption-regular text-p1-regular text-tertiary-800 underline"
                >
